...
class TestVimrcCreator < Test::Unit::TestCase
  def setup
    ...
    @container_id = "testcontainerid1234"
  end
  ...
  def fixed_options
    vimrc_creator = VimFactory::VimrcCreator.new({}, @filepath_fixed, @container_id)
  ...
  def test_create_with_option_none
    vimrc_creator = VimFactory::VimrcCreator.new({}, @filepath, @container_id)
    vimrc_creator.create
  ...
  def test_create_with_toggle_option_true
    contents = { "ruler" => true }
    vimrc_creator = VimFactory::VimrcCreator.new(contents, @filepath, @container_id)
    vimrc_creator.create
